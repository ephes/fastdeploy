...
from ..pydantic_models import PService
...
async def create_service(
    ...
    """
    print("current active user: ", _)
    # service.id = None  # prevent client from setting the id
    service = Service(name=pservice.name, data=pservice.data)  # prevent client from setting the id
